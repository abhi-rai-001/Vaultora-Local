  ...
  return (
    <footer className="pale-blue mt-10">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="flex flex-col md:flex-row md:justify-between gap-8">
          <div className="flex flex-col items-center md:items-start space-y-4">
            <a href="#" className="flex items-center ">
              <img src={Logo} className="w-16 md:w-20 h-auto" alt="Logo" />
          ...
          <div className="grid grid-cols-2 gap-8 text-center md:text-left">
            <div>
              ...
              <ul className="text-gray-400 font-medium space-y-2">
                <li>
                  <a 
                    href="https://github.com/abhi-rai-001" 
                ...
                <li>
                  <a 
                    href="https://www.instagram.com/its_abhinavrai/" 
                    className="hover:underline hover:text-white transition-colors"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
        ...
        <hr className="my-8 border-gray-500 sm:mx-auto" />

        <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
          <div className="flex flex-col sm:flex-row items-center gap-2 text-sm text-gray-400">
            <div>© {year} <a href="#" className="hover:underline hover:text-white transition-colors">Vaultora™</a></div>
          ...
          <div className="flex space-x-4">
            ...
            <a href="https://github.com/abhi-rai-001" className="text-gray-400 hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
